...
import type { TaskCardState } from './TaskCard.types';

const STATES: Array<'auto' | TaskCardState> = ['auto', 'default', 'hover'];
...
export default function TaskCardPreviewPage() {
  const [state, setState] = useState<'auto' | TaskCardState>('auto');
  const [interactive, setInteractive] = useState(true);
  const [showDescription, setShowDescription] = useState(true);
  const [showSecondTag, setShowSecondTag] = useState(true);
      ...
      >
        ...
        >
          <label style={{ display: 'grid', gap: spacing.scale['4'] }}>
            ...
            <select
              value={state}
              onChange={(event) => setState(event.target.value as 'auto' | TaskCardState)}
              style={{
          ...
          >
            ...
            <input type="checkbox" checked={showSecondTag} onChange={(event) => setShowSecondTag(event.target.checked)} />
          </label>
        </section>
        ...
        >
          ...
          <TaskCard
            ...
            description={
              showDescription ? 'Design better and spend less time without restricting creative freedom.' : ''
            }
            tags={tags}
          />
        </section>
        ...
        >
          ...
          <div style={{ display: 'grid', gap: spacing.scale['12'] }}>
            <TaskCard state="default" interactive={false} />
            <TaskCard state="hover" interactive={false} />
          </div>
        </section>
      </section>
    </main>
